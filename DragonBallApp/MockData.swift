...
struct MockData {
    static let dbCharacters: [DBZCharacter] = [
        ...
        DBZCharacter(id: 3, name: "Freezer", ki: "10.000.000", maxKi: "90 Septillion", race: "Saiyan", gender: .male, description: "Freezer es el tirano espacial y el principal antagonista de la saga de Freezer..", image: "http://dragonball-api.com/characters/picolo_normal.webp", affiliation: "Army of Frieza"),
    ]
}
